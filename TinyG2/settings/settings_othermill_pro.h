...
#define X_VELOCITY_MAX 5060
#define Y_VELOCITY_MAX 5060
#define P1_CW_SPEED_HI 14000
#define P1_CW_SPEED_LO 2000
#define P1_CW_PHASE_HI 0.2
#define P1_CW_PHASE_LO 0.12

#undef PAUSE_DWELL_TIME
#define PAUSE_DWELL_TIME 5.0

#undef MOTOR_POWER_LEVEL
#undef MOTOR_POWER_LEVEL_Z
#define MOTOR_POWER_LEVEL 0.6
#define MOTOR_POWER_LEVEL_Z 0.6
